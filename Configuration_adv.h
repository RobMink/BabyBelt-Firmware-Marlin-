...
// LCD Print Progress options
  ...
  #define EVENT_GCODE_SD_ABORT "G28Y"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       90        // (mA) RMS current. Multiply by 1.414 for peak current.
