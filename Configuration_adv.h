...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 1.4, 1.4, 0 } // (linear=mm, rotational=°) One value for each linear axis
 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       53      // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  65  // (mA) RMS current for sensorless homing
...
//#define CUSTOM_USER_BUTTONS
  ...
  //#define BUTTON1_PIN PIN_A15
  #if PIN_EXISTS(BUTTON1)
    #define BUTTON1_HIT_STATE     LOW       // State of the triggered button. NC=LOW. NO=HIGH.
    #define BUTTON1_WHEN_PRINTING false     // Button allowed to trigger during printing?
    #define BUTTON1_GCODE         "M24"
    #define BUTTON1_DESC          "PRINT"  // Optional string to set the LCD status
  #endif
